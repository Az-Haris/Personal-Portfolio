...
const ExperienceSection = () => {
  const experiences = [
    ...
    },
    {
      ...
      period: "2024 - Present",
      description:
        "Building dynamic web applications using modern MERN stack technologies.",
    },
  ];
        ...
        <div className="relative container mx-auto px-4 py-24">
          ...
          <div className="flex flex-col items-center space-y-6 mb-16">
            <div className="relative">
              <h2 className="text-4xl md:text-6xl font-extrabold text-transparent bg-gradient-to-br from-indigo-400 via-purple-400 to-pink-500 bg-clip-text pb-3">
                Professional Journey
              </h2>
              <div className="absolute inset-0 -z-10 bg-gradient-to-r from-purple-400/30 to-indigo-400/30 blur-xl rounded-xl" />
            </div>
            <p className="text-sm md:text-lg text-center text-gray-400 font-medium italic tracking-wide">
              &quot;Growth, Challenges, Learning, Dedication, Innovation,
              Success...&quot;
            </p>
