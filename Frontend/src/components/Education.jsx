  ...
  const educationData = [
    {
      ...
      school: "Trust University, Barishal",
      mascot: "📗",
      year: "2022 - Present",
      achievements: ["CGPA: ---", "Subject: Computer Science and Engineering"],
    },
    {
      degree: "Higher Secondary Certificate (HSC)",
      school: "Govt. BM College, Barishal",
      mascot: "📗",
      year: "2022",
      achievements: ["GPA: 4.92", "Subject: Science"],
    },
    {
      degree: "Secondary School Certificate (SSC)",
      school: "Govt. Nalchity Merchants' Secondary School",
      mascot: "📘",
      year: "2020",
